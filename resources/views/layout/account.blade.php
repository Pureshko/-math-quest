                    ...
                    <nav class="mt-2">
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
                            ...
                            <li class="nav-item has-treeview">
                                ...
                                @if(session('page')=='problemset'||explode('/',session('page'))[0]=='problem'):
                                    {{$current_page = explode('/',session('page'))[1]}}
                                    <ul class="nav nav-treeview">
                                        @foreach($problems as $problem)
                                            <li class="nav-item">
                                                <a href="/problem/{{$problem->id}}" class="nav-link {{ $current_page==$problem->id ? 'active' : ''}}">
